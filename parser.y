...
declaracao_funcao_assinatura: identificador           identificador '(' primeiro_param_funcao ')'              { $$ = make_node(NODE_FUNCTION_HEADER); $$->child[0] = make_node(NODE_EMPTY);  $$->child[1] = $1; $$->child[2] = $2; $$->child[3] = $4; set_new_scope_semantic(); };
declaracao_funcao_assinatura: tipo_variavel_primitiva identificador '(' primeiro_param_funcao ')'              { $$ = make_node(NODE_FUNCTION_HEADER); $$->child[0] = make_node(NODE_EMPTY);  $$->child[1] = $1; $$->child[2] = $2; $$->child[3] = $4; set_new_scope_semantic(); };
declaracao_funcao_assinatura: TK_PR_STATIC tipo_variavel           identificador '(' primeiro_param_funcao ')' { $$ = make_node(NODE_FUNCTION_HEADER); $$->child[0] = make_node(NODE_STATIC); $$->child[1] = $2; $$->child[2] = $3; $$->child[3] = $5; set_new_scope_semantic(); };
